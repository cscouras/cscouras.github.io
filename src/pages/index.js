...
const IndexPage = () => (
  <ContentContainer>
    <h1>Hey! I am Chris Scouras and this is my portfolio site.</h1>
    <p>
    ...
    <p>
      I have received my{" "}
      <a href="https://www.freecodecamp.org/cscouras/front-end-certification" target="_blank" rel="noopener noreferrer">
      ...
      { " " }<Link to="/projects">projects section
      </Link>
